...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("id", "paper_id", "paper_revision", "paper_file_id", "parser_run_id", name="uq_document_blocks_identity"),
    )
...
def downgrade():
    op.drop_index("ix_paper_evidence_locators_page", table_name="paper_evidence_locators")
    op.drop_index("ix_paper_evidence_locators_document_block_id", table_name="paper_evidence_locators")
    op.drop_index("ix_paper_evidence_locators_parser_run_id", table_name="paper_evidence_locators")
    op.drop_index("ix_paper_evidence_locators_paper_file_id", table_name="paper_evidence_locators")
    op.drop_index("ix_paper_evidence_locators_paper_id", table_name="paper_evidence_locators")
    op.drop_index("ix_paper_evidence_locators_paper_evidence_id", table_name="paper_evidence_locators")
    op.drop_table("paper_evidence_locators")
    op.drop_index("ix_document_blocks_page", table_name="paper_document_blocks")
    op.drop_index("ix_document_blocks_parser_run_id", table_name="paper_document_blocks")
    op.drop_index("ix_document_blocks_paper_file_id", table_name="paper_document_blocks")
    op.drop_index("ix_document_blocks_paper_id", table_name="paper_document_blocks")
    op.drop_table("paper_document_blocks")
    op.drop_index("ix_document_parser_runs_file_revision", table_name="paper_document_parser_runs")
    op.drop_index("ix_document_parser_runs_paper_id", table_name="paper_document_parser_runs")
