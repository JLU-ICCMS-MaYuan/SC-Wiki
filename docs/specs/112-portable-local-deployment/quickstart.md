...
> 本文是待实现功能的验收步骤。2026-09-21 仅完成规划；以下新命令、脚本和结果尚未实现或运行。

## 前置条件

- 使用可丢弃的 Ubuntu 22.04/24.04 x86_64 或 WSL2 Ubuntu 测试实例，能联网下载依赖，当前用户可写部署目录。
- 准备 Bash、Make、Python 3、curl、tar；源端有 Git，Docker 已安装、运行且当前用户可访问。
