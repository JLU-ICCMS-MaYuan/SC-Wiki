...
- 迁移 `20260917_0107` 依赖 `20260916_0106`，2026-09-17 已经用户确认应用至本地 `scwiki`；六张社区表已建立，当前 Go/Vite 读取与页面恢复正常，实际数据库写入回滚检查通过。当前账号发布反馈与其他环境部署仍分别记录，见[本地启用验收](../../specs/106-community-discussion/quickstart.md)。
